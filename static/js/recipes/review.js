...
reviewSubmit.addEventListener('click', (e) => {
  ...
  $.ajax({
    ...
    success:function(data) {
      ...
      reviewElement.setAttribute('data-csrftoken', reviewForm.dataset.csrftoken);
      ...
      reviewElement.classList.add('flex', 'text-sm', 'gap-3', 'py-5', 'px-3', 'border-b', 'bg-[#9ACD32]/[0.2]');

      const profileImageWrapper = document.createElement('div')
      profileImageWrapper.classList.add('flex', 'items-start', 'gap-3', 'mb-1')
      ...
      if (data.profile_image) {
        ...
        profileImage.setAttribute('src', 'http://127.0.0.1:8000/static/img/profile_image2.png');
      }
      ...
      newDropdownBtn.setAttribute('data-dropdown-toggle', `dropdown-${data.review_pk}`)
      ...
      newDropdownContentWrapper.setAttribute('id', `dropdown-${data.review_pk}`)
      newDropdownContentWrapper.classList.add('z-10', 'hidden', 'bg-white', 'divide-y', 'divide-gray-100', 'rounded-lg', 'shadow', 'w-20', 'dark:bg-gray-700')
      ...
      newDropdownContentUl.classList.add('py-2', 'text-sm', 'text-gray-700', 'dark:text-gray-200')
      newDropdownContentUl.setAttribute('aria-labelledby', 'dropdownDefaultButton')
      ...
      newDropdownContentLiEditAtag.classList.add('block', 'm-0', 'px-4', 'py-2', 'hover:bg-gray-100', 'dark:hover:bg-gray-600', 'dark:hover:text-white', 'cursor-pointer')
      ...
      newDropdownContentLiDeleteAtag.classList.add('block', 'm-0', 'px-4', 'py-2', 'hover:bg-gray-100', 'dark:hover:bg-gray-600', 'dark:hover:text-white', 'cursor-pointer')
